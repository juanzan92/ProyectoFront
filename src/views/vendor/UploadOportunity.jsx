...
class UploadOportunity extends React.Component {
  ...
  async iterateAllFiles(allFiles){
    ...
    try {
      for (let i = 0; i < allFiles.length; i++) {
        ...
        const imgObject =  await this.uploadFileToAWS(formData, fileName, fileType)
  ...
  postItem = (flag) => {
    ...
    this.setDimensions(this.state.alto, this.state.ancho, this.state.profundidad, this.state.peso);
                ...
                <div className="form-group row">
                  <div className="col-8">
                      <button 
                          ...
                          type="submit" 
                          disabled={this.state.isButtonDisabled}>PUBLICAR
                      </button>
                  </div>
                </div>
