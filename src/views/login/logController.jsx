    ...
    return (
      <>
        <div>
          ...
          <div
            className="btn btn-success"
            onClick={this.signIn("testuser2", "password123")}
          >
            {" "}
            signIn
          </div>
          <div className="btn btn-success" onClick={this.signOut}>
            {" "}
            signOut
          </div>
          <div
            className="btn btn-success"
            onClick={this.changePassword("password123", "password111")}
          >
            {" "}
            changePassword
          </div>
          <div
            className="btn btn-success"
            onClick={this.forgotPassword("carlos")}
          >
            {" "}
            forgotPassword
          </div>
          <div
            className="btn btn-success"
            onClick={this.verifyCurrentUserAttribute}
          >
            {" "}
