...
class FileUpload extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      map: [],
      url:
        "https://s-market-images.s3.amazonaws.com/1570915087753-logo-smarket.png",
      urlx: "",
  ...
  forcita(allFiles) {
    ...
    for (let i = 0; i < allFiles.length; i++) {
      ...
      this.handleFileUpload(formData, i, vectorSalida);
      ...
      vectorSalida.push(img);
    }
    this.setState({
      pictures: vectorSalida
    });
  }
  ...
  handleSubmit(event) {
    ...
    this.forcita(allFiles).then(this.postItem());
  }
