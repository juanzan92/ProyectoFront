              ...
              <div className="container">
                ...
                <div className="row">
                  ...
                  <div className="col-md-5 padding-bottom-1x">
                    ...
                    {/*Subscription*/}
                    <form className="subscribe-form" action="//rokaux.us12.list-manage.com/subscribe/post?u=c7103e2c981361a6639545bd5&amp;id=1194bb7544" method="post" target="_blank" noValidate>
